...
var file_AuthService_proto_rawDesc = []byte{
	...
	0x22, 0x33, 0x0a, 0x0c, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x38, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x14, 0x0a,
	...
	0x52, 0x0a, 0x08, 0x41, 0x75, 0x74, 0x68, 0x44, 0x61, 0x74, 0x61, 0x12, 0x21, 0x0a, 0x0c, 0x61,
	...
	,
...
var file_AuthService_proto_goTypes = []any{
	(*RefreshToken)(nil), // 0: AuthService.RefreshToken
	(*User)(nil),         // 1: AuthService.User
	(*AuthData)(nil),     // 2: AuthService.AuthData
}
var file_AuthService_proto_depIdxs = []int32{
	1, // 0: AuthService.Authentification.Register:input_type -> AuthService.User
	1, // 1: AuthService.Authentification.Login:input_type -> AuthService.User
	0, // 2: AuthService.Authentification.UpdateTokens:input_type -> AuthService.RefreshToken
	2, // 3: AuthService.Authentification.Register:output_type -> AuthService.AuthData
	2, // 4: AuthService.Authentification.Login:output_type -> AuthService.AuthData
	2, // 5: AuthService.Authentification.UpdateTokens:output_type -> AuthService.AuthData
