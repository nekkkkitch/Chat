...
const (
	Messages_EnterChat_FullMethodName   = "/MsgService.Messages/EnterChat"
	Messages_SendMessage_FullMethodName = "/MsgService.Messages/SendMessage"
	Messages_GetMessages_FullMethodName = "/MsgService.Messages/GetMessages"
)
...
func (c *messagesClient) GetMessages(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Chat, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Chat)
...
func (UnimplementedMessagesServer) GetMessages(context.Context, *Message) (*Chat, error) {
...
func _Messages_GetMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessagesServer).GetMessages(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Messages_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "MsgService.Messages",
